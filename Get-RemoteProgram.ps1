# Get-RemoteProgram 1.2.1

#Essa função gera uma lista consultando o registro e retornando os programas instalados de um computador local ou remoto.
...
.GUID c2d86c61-196d-40cd-9cca-7183fb44cc14
...
#https://www.powershellgallery.com/packages/Get-RemoteProgram/1.2.1/Content/Get-RemoteProgram.ps1
##
